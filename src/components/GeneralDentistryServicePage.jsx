      ...
      <div className="max-w-6xl mx-auto px-4 py-16">
        ...
        <section className="mb-16">
          <div className="bg-gradient-to-r from-green-50 to-teal-50 rounded-2xl p-8">
            <h2 className="text-3xl font-bold text-gray-800 mb-6 flex items-center">
              ...
              🛡️ Preventive Care & Daily Habits
            </h2>
            <div className="grid md:grid-cols-2 gap-8">
              <div>
                <h3 className="text-xl font-semibold text-gray-800 mb-4">🏠 At-Home Care</h3>
              ...
              <div>
                <h3 className="text-xl font-semibold text-gray-800 mb-4">🏥 Professional Care</h3>
                <ul className="space-y-2 text-gray-700">
                  <li className="flex items-center">
                    <CheckCircle className="w-5 h-5 text-green-500 mr-2" />
                  ...
                  <li className="flex items-center">
                    <CheckCircle className="w-5 h-5 text-green-500 mr-2" />
                    Dental sealants for cavity protection 🛡️
                  </li>
                </ul>
              </div>
            </div>
        ...
        <section className="mb-16">
          ...
          <div className="grid md:grid-cols-4 gap-6">
            {[
              { step: "1", icon: "📋", title: "Health History", desc: "Review medical history and   dental history" },
              { step: "2", icon: "🔍", title: "Examination", desc: "Comprehensive oral health assessment" },
              { step: "3", icon: "🪥", title: "Cleaning", desc: "Professional cleaning and polishing" },
              { step: "4", icon: "💬", title: "Treatment Plan", desc: "Discuss findings and recommendations" }
            ].map((process, index) => (
